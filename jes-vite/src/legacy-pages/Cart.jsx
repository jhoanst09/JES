        ...
        <div className="min-h-screen flex flex-col text-white">
            ...
            <main className="flex-1 px-6 pt-32 pb-32 max-w-2xl mx-auto w-full">
                <header className="mb-12 space-y-2">
                    <h1 className="text-4xl font-black uppercase tracking-tighter italic">Tus <span className="text-blue-500">Regalos</span> 🎁</h1>
                    <p className="text-[10px] text-zinc-500 uppercase tracking-widest font-black">
                        {cart.length > 0 ? `Tienes ${cart.length} vales esperando` : 'Tu carrito está vacío'}
                    </p>
                </header>
                ...
                <div className="space-y-6">
                    {cart.length > 0 ? (
                                    ...
                                    {!isLoggedIn && (
                                        <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-2xl mb-4">
                                            <p className="text-[10px] text-blue-400 font-bold uppercase tracking-widest text-center">
                                                🚀 <Link to="/profile" className="underline hover:text-blue-300">Inicia sesión</Link> para envío GRATIS
                                            </p>
                                        </div>
                                    )}
                        ...
                        <div className="py-24 text-center space-y-8 flex flex-col items-center">
                            ...
                            <Link to="/" className="px-10 py-4 bg-blue-500 text-white font-black rounded-full uppercase tracking-widest text-xs shadow-xl shadow-blue-500/20 active:scale-95 transition-all">Ir a la Tienda</Link>
                        </div>
                    )}
                </div>
            </main>
