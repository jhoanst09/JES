    ...
    return (
        <div className="fixed bottom-6 left-6 right-6 z-50 md:hidden h-[65px] bg-black/80 backdrop-blur-xl border border-white/10 rounded-[32px] flex items-center shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
            <nav className="flex items-center justify-around w-full px-2">
                {/* 1. Inicio (Dual Feed) */}
                <Link to="/" className={`flex flex-col items-center p-2 rounded-2xl transition-all ${isActive('/') ? 'text-blue-500 bg-blue-500/10' : 'text-white/60 hover:text-white'}`} aria-label="Inicio">
                ...
                <Link to="/explore" className={`flex flex-col items-center p-2 rounded-2xl transition-all ${isActive('/explore') ? 'text-blue-500 bg-blue-500/10' : 'text-white/60 hover:text-white'}`} aria-label="Explorar">
                ...
                <Link to="/chat" className={`flex flex-col items-center p-2 rounded-2xl transition-all relative ${isActive('/chat') ? 'text-blue-500 bg-blue-500/10' : 'text-white/60 hover:text-white'}`} aria-label="Mensajería">
                    ...
                    <span className="absolute top-1 right-1 w-2 h-2 bg-blue-500 rounded-full animate-pulse border-2 border-black" />
                </Link>
                ...
                {/* 5. Perfil */}
                <Link to="/profile" className={`flex flex-col items-center p-2 rounded-2xl transition-all relative ${isActive('/profile') ? 'text-blue-500 bg-blue-500/10' : 'text-white/60 hover:text-white'}`} aria-label="Perfil">
